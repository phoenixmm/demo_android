...
public class MainActivity_testImageBroser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_imagebrowser);
        ...
        testBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                imageBrowserView.post(new Runnable() {
                    @Override
                    public void run() {
                        imageBrowserView.init(MainActivity_testImageBroser.this, position%6, top, articleBean);
